...
public class RobotPlayer {
	...
	public static void run(RobotController rc) {
		...
		MapLocation congregate = new MapLocation(154, 298);
        ...
        if (rc.getType() == RobotType.ARCHON) {
            ...
            while (true) {
                ...
                try {
					...
					dirToMove = myloc.directionTo(congregate);
...
*/ // removed silly random signal stuff
                    if (rc.isCoreReady()) {
                        if (fate < 800 && myloc.distanceSquaredTo(congregate) > 50) {
                            ...
                            if (rc.senseRubble(rc.getLocation().add(dirToMove)) >= GameConstants.RUBBLE_OBSTRUCTION_THRESH) {
								...
								// added to somewhat commit to a direction
							...
							if(myloc.distanceSquaredTo(congregate) > 80) {
                            	typeToBuild = robotTypes[fate % 7];
							} else {
